...
int vitalsOk(float temperature, float pulseRate, float spo2) {
    bool isTempNormal = isParametersNormal(temperature, MAX_TEMP, MIN_TEMP, "Temperature is critical!\n");
    bool isPulseNormal = isParametersNormal(pulseRate, MAX_PULSE, MIN_PULSE, "Pulse Rate is out of range!\n");
